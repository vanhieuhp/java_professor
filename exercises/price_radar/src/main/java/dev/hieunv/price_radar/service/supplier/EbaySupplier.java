...
@Component
public class EbaySupplier implements Supplier {

    @Override
    public PriceResult getPrice(String productName) {
        long start = System.currentTimeMillis();
        simulateDelay();
        double price = 750 + ThreadLocalRandom.current().nextDouble(0, 200); // $750–$950
        return new PriceResult("Ebay", productName, price, System.currentTimeMillis() - start);
    }
