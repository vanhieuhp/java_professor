...
INSERT INTO products (id, name, price, stock, status, saga_id, version) VALUES
  (1,  'Laptop Pro 15',    25000000.00, 50,  'AVAILABLE',   NULL, 0),
  (2,  'Wireless Mouse',     450000.00, 200, 'AVAILABLE',   NULL, 0),
  (3,  'Mechanical Keyboard',950000.00, 150, 'AVAILABLE',   NULL, 0),
  (4,  'USB-C Hub',          380000.00, 300, 'AVAILABLE',   NULL, 0),
  (5,  'Monitor 27"',      8500000.00,  30, 'AVAILABLE',   NULL, 0),
  (6,  'Webcam HD',          750000.00, 80,  'AVAILABLE',   NULL, 0),
  (7,  'SSD 1TB',           2200000.00, 60,  'AVAILABLE',   NULL, 0),
  (8,  'Headphones',        1500000.00, 90,  'AVAILABLE',   NULL, 0),
  (9,  'Phone Stand',        120000.00, 500, 'AVAILABLE',   NULL, 0),
  (10, 'Vintage Keyboard',   550000.00, 0,   'OUT_OF_STOCK',NULL, 0);
