...
public class KafkaConfig {
    ...
    public ConcurrentKafkaListenerContainerFactory<String, Object> kafkaListenerContainerFactory(
        ...
        props.put(ConsumerConfig.GROUP_ID_CONFIG, "bankos-payment-group");
        ...
        props.put(JsonDeserializer.TRUSTED_PACKAGES, "dev.hieunv.bankos.*");
        props.put(JsonDeserializer.TYPE_MAPPINGS,
                "paymentProcessed:dev.hieunv.bankos.dto.payment.PaymentProcessedEvent," +
                        ...
                        "userRegistered:dev.hieunv.bankos.dto.notification.UserRegisteredEvent," +
                        "walletLocked:dev.hieunv.bankos.dto.notification.WalletLockedEvent");
